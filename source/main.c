...
*
* Update - 	19-Oct-2022 (djjw)
* 			Added two tasks:
* 				1. Simple LED task to blink USER_LED
* 				2. TFT task to print scan results
* 			Notes:
* 				1. Use Library Manager to add emWin release-v6.26.0 and
* 					display-tft-st7789v release-v1.0.1
* 				2. Modify Makefile to include EMWIN_OSNTS component:
* 					COMPONENTS=EMWIN_OSNTS FREERTOS MBEDTLS LWIP
*
...
int main()
{
    ...
    /* Create the TFT task */
    xTaskCreate(tft_task, "tftTask", TFT_TASK_STACK_SIZE, NULL, TFT_TASK_PRIORITY, NULL);
